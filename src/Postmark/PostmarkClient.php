...
use Postmark\Models\PostmarkMessageDump;
...
class PostmarkClient extends PostmarkClientBase
{
     ...
     * @param null|string $messageID     Filter by MessageID (a GUID, e.g. 454ef8fc-da5f-4662-b6d6-74a54d78504d)
